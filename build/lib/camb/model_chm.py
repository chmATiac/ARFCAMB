...
class CAMBparams(F2003Class):
    ...
    _fields_ = [
        ...
        ("AIA", c_double, "IA amplitude in Non-linear-Aligment model of IA"), # chm, added
        ("epsIA", c_double, "IA redshift exponent in Non-linear-Aligment model of IA"), # chm, added
        ("betaIA", c_double, "IA luminosity exponent in Non-linear-Aligment model of IA"), # chm, added
        ("f_NL", c_double, "local non-Gaussianity parameter"), # chm, added
    ]
    ...
    def set_cosmology(self, H0: Optional[float] = None, ombh2=0.022, omch2=0.12, omk=0.0,
                      ...
                      #AIA :Optional[float] = None, epsIA :Optional[float] = None, betaIA :Optional[float] = None, 
                      #f_NL :Optional[float] = None): # chm, included last four parameters
                      AIA=1.72, epsIA=-0.41, betaIA=2.17, f_NL=0.): # chm, included last four parameters
        r"""
        ...
        self.Alens = Alens
        self.AIA = AIA # chm
        self.epsIA = epsIA # chm
        self.betaIA = betaIA # chm
        self.f_NL = f_NL # chm

...
pars.SourceWindows = [ SplinedSourceWindow(bias=1.,source_type='arf',dlog10Ndm=0.0, z=zS, W=dndzSnp.exp(-0.5(zS-1.)2/0.012), bias_z=np.sqrt(1+zS), sigma_Errz=0.01], i_Lorentz=0 )

    ...
    if (State%num_redshiftwindows > 0) then
        ...
        do i=1,State%num_redshiftwindows
            ...
            !ARF
                allocate(Win%wingZ(nstep),Win%ddwingZ(nstep),Win%WinFZ(nstep),Win%WinF2(nstep))
            !ARF ___
    ...
    do i = 1, State%num_redshiftwindows
        associate (RedWin => State%Redshift_W(i))
            ...
            RedWin%z_prom=RedWin%WinFZ(TimeSteps%npoints) / RedWin%WinF(TimeSteps%npoints)
            print*,'TESTS, window_i, z_prom = ',i,RedWin%z_prom
            !ARF------------------------------------------------------

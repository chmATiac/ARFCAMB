    ...
    integer, parameter :: window_21cm = 1, window_counts = 2, window_lensing = 3, window_arf = 4, window_vlos=5 !declares parameters [CHM] We have included window_arf, window_vlos
    ...
    Type SourceTermParams
        ...
        logical :: counts_vlos_source = .false. ! CHM - introducing vlos under W(z) as another source
        logical :: lensing_IA = .false. ! CHM

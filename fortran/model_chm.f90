    ...
    type, extends (TCAMBParameters) :: CAMBparams
        ...
        real(dl)  :: AIA = 1.72_dl  ! [chm] Parameter of IA (NLA model)
        real(dl)  :: epsIA = -0.41_dl ! [chm] Parameter of IA (NLA model)
        real(dl)  :: betaIA = 2.17_dl ! [chm] Parameter of IA (NLA model)
        real(dl) :: f_NL = 0._dl ! [chm] Local-type Non-Gaussianity parameter
